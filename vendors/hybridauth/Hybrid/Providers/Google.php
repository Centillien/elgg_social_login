...
{
	// default permissions 
	public $scope = "https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email https://www.google.com/m8/feeds/ https://www.googleapis.com/auth/plus.login";
	...
	*/
	function getUserProfile()
	{
		...
		$this->user->profile->description   = (property_exists($response,'tagline'))?$response->tagline:"";
		...
		$this->user->profile->region        = (property_exists($response,'currentLocation'))?$response->currentLocation:"";
